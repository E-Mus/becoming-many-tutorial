 ...
 * folgt. Die aktiven Fuehrungsmodi benutzen diese eine Funktion; sie
 * unterscheiden sich nur darin, WELCHE Achse als `s` in die Slots eingebacken
 * wurde.
 *
 *   Fern       s = Position entlang der Zeigerichtung   dir +1
 *   Begleiter  s = Position entlang der Zeigerichtung   dir +1
 *
